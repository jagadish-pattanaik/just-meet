...
class RecentHosted extends StatefulWidget {
  final name;
  final email;
  final uid;
  final url;
  const RecentHosted({Key key,
    @required this.name,
    this.email,
    this.uid,
    this.url,})
  ...
  @override
  _RecentHostedState createState() => _RecentHostedState(name, email, uid, url);
}

class _RecentHostedState extends State<RecentHosted> {
  final name;
  final email;
  final uid;
  final url;
  _RecentHostedState(this.name, this.email, this.uid, this.url);
